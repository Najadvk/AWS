...
Next, the permissions of the low-privileged user were assessed by enumerating accessible AWS services and IAM actions using Pacu, an AWS exploitation framework.
